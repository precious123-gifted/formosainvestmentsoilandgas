...
...restProps
  ...
  return (
    <Comp className={clsx("w-full  h-fit mt-[-140vw]  flex bg-[#080e0f] backdrop-filter backdrop-blur-md flex-col  items-center overflow-x-hidden  ",className)  } {...restProps} style={pontanoSans.style}>
