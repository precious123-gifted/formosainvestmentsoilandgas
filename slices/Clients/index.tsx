...
const Clients = ({ slice }: ClientsProps): JSX.Element => {
  ...
  return (
   ...
   className="  text-[#333D3E] bg-[#EDF4F6]" 
    >
<div className="content w-full flex flex-col items-center  pb-[6vw] space-y-[4vw] portrait:space-y-[12vw]"> 
<div className="clients_writeup_lead text-center mb-4 portrait:mt-10  portrait:mb-10 mt-4 text-[2vw]  portrait:text-[6vw] portrait:sm:text-[3vw]">{slice.primary.writeup}</div>
